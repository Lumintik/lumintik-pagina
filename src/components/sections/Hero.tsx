...
export function Hero() {
  ...
  const onScene = useCallback((i: number) => {
      ...
      <div className="grid w-full max-w-[1600px] mx-auto gap-12 xl:grid-cols-[1.05fr_1fr] xl:gap-16 items-center">
        ...
        <div className="text-center xl:text-left">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center xl:items-start gap-3 justify-center xl:justify-start" style={reveal(520)}>
            <a
              href="#contact"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-white text-slate-900 text-sm font-medium hover:bg-blue-300 transition-colors duration-300 w-full sm:w-auto"
            >
              {t.hero.startProject}
        ...
        <div className="w-full max-w-[560px] mx-auto xl:max-w-none" style={reveal(300)}>
          <HeroDemo locale={locale} onScene={onScene} />
        </div>
      </div>
    </header>
  );
