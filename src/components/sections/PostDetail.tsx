          ...
          <aside className="hidden lg:block lg:col-span-4">
            <div className="sticky top-28 flex flex-col gap-10">
              <nav aria-label={t.pages.blog.toc}>
                <p className="text-xs font-medium text-slate-400">{t.pages.blog.toc}</p>
              ...
              <div>
                <p className="text-xs font-medium text-slate-400">{t.pages.blog.share}</p>
              ...
              {others.length > 0 ? (
                <div>
                  <p className="text-xs font-medium text-slate-400">{t.pages.blog.suggestions}</p>
